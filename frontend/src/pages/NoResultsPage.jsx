    ...
    return (
      <div className="container">
        <div className="row text-center my-4">
          <h1 className="col-12 text-danger mt-3">
            Voi ei! Hakusanalla ei löytynyt yhtään tulosta :(
          </h1>
        </div>
        ...
        <div className="row justify-content-center mb-3">
          ...
          <div className="row justify-content-center mb-3">
            <ul className="list-group list-group-horizontal text-center col-12">
                <a href="/mukit" className="list-group-item list-group-item-action bg-secondary text-white rounded">
                <span className="fa fa-coffee" style={{fontSize:"60px"}}></span>
                </a>
                <a href="/lautaset" className="list-group-item list-group-item-action bg-secondary text-white mx-1 rounded">
                <span className="fa fa-circle-o" style={{fontSize:"60px"}}></span>
                </a>
                <a href="/lasit" className="list-group-item list-group-item-action bg-secondary text-white rounded">
