    ...
    <div>
      ...
      <div className='row justify-content-center'>
        <div className='card col-12 col-md-5 p-4 mx-auto mt-2 mb-5'>
          ...
          <Link to='/kirjaudu' className='col-12 p-3 mt-3 btn btn-primary' type='button'>
            Kirjaudu sisään
          </Link>
        </div>
      </div>
      <div className='row justify-content-center'>
        <div className='col-12 col-md-5 card p-4 mx-auto mt-2 mb-5'>
          ...
          <p className='mt-3'>
            Huomaa, että emme voi tallentaa tietojasi seuraavaa ostoskertaasi
            varten. Jos luot profiilin, voit myös tarkastella tilaushistoriaasi
            sekä muuttaa tilaustasi tai peruuttaa sen verkossa.
          </p>
