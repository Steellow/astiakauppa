...
export default function SingleProduct({ item, handleRemove, callBack }) {
  ...
  return (
    <div className="row p-3 border-bottom">
      ...
      <h2 className="d-inline align-top col-12 col-sm-8 col-md-7 h-min">
        <Link to={`/tuote/${product.id}`} style={{ color: "inherit", textDecoration: "inherit" }}>
          {product.name}
        </Link>
      </h2>
      <div className="col-12 col-sm-4 col-md-2 d-flex justify-content-between flex-column align-end text-right p-0">
